...
- ✅ Accent → **Full migration** — Gray base, Orange `#FF6600` accent, **kill all indigo**
...
| `--accent` | `#FF6600` | **AdaptivOrange** — CTAs, active states, brand accents |
...
- `bg-indigo-600` user bubbles → `bg-[#FF6600]` orange
- `text-indigo-400/500` accents → `text-[#FF6600]`
- `bg-indigo-500/20` highlights → `bg-[#FF6600]/20`
...
- Active conversation: `bg-indigo-600/20 border-indigo-500/30` → `bg-[#FF6600]/15 border-[#FF6600]/30`
- Active dot: `bg-indigo-400` → `bg-[#FF6600]`
- New Workspace "+" icon: `text-indigo-400` → `text-[#FF6600]`
